...
;(function(global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    ? define(['buffer', 'fs', 'util', 'stream', 'zlib', 'assert'], factory)
    : ((global = global || self),
      (global.QrcodeVue = factory(
        global.buffer$1,
        global.fs,
        global.util,
        global.stream,
...
})(this, function(buffer$1, fs, util, stream, zlib, assert) {
  'use strict'

  buffer$1 =
    buffer$1 && buffer$1.hasOwnProperty('default')
      ? buffer$1['default']
      : buffer$1
  ...
  assert =
    assert && assert.hasOwnProperty('default') ? assert['default'] : assert
    ...
    exports.getBestMask = function getBestMask(data, setupFormatFunc) {
      ...
      for (var p = 0; p < numPatterns; p++) {
        ...
        var penalty =
          ...
          exports.getPenaltyN4(data) // Undo previously applied mask
  ...
  var version = createCommonjsModule(function(module, exports) {
    ...
    exports.getCapacity = function getCapacity(
      ...
      var usableBits =
        dataTotalCodewordsBits - getReservedBitsCount(mode$1, version) // Return max number of storable codewords
...
*/
  ...
  function createCodewords(bitBuffer, version, errorCorrectionLevel) {
    ...
    var maxDataSize = 0
    var buffer$1 = new buffer(bitBuffer.buffer) // Divide the buffer into the required number of blocks

    for (var b = 0; b < ecTotalBlocks; b++) {
      var dataSize =
        b < blocksInGroup1 ? dataCodewordsInGroup1 : dataCodewordsInGroup2 // extract a block of data from buffer
  ...
  var filterParse = createCommonjsModule(function(module) {
    ...
    Filter.prototype._unFilterType4 = function(
      ...
      for (var x = 0; x < byteWidth; x++) {
        ...
        var f4UpLeft =
          x > xBiggerThan && lastLine ? lastLine[x - xComparison] : 0
  ...
  var packerSync = function(metaData, opt) {
    ...
    var filteredData = packer$1.filterData(
      metaData.data,
      metaData.width,
      metaData.height
    ) // compress it
  ...
  var utf8 = createCommonjsModule(function(module, exports) {
    ...
    exports.render = function(qrData, options, cb) {
      ...
      if (
        opts.color.dark.hex === '#ffffff' ||
        opts.color.light.hex === '#000000'
      ) {
